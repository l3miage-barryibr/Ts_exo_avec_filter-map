...
LogTests<Parameters<typeof multipleDe3>, ReturnType<typeof multipleDe3>>(
  "Fonction qui filtre les multiples de 3", multipleDe3, "multipleDe3", [
...
function taille5(...L: string[]): string[] {
    // à compléter
    return [...L].filter(x => x.length >= 5);
}
LogTests<Parameters<typeof taille5>, ReturnType<typeof taille5>>(
  "string de taille >= à 5", taille5, "taille5", [
    {args: ["a", "coucou ça va", "bob", "oui oui"], expectedResult: [
      "coucou ça va",
      "oui oui"
    ]},
    {args: [], expectedResult: []}
...
function exo3(...L: string[]): {s: string, t: number}[] {
    ...
    return L
      ...
      .map((str => ({s: str.toUpperCase(), t: str.length})));
}
LogTests<Parameters<typeof exo3>, ReturnType<typeof exo3>>(
  "Filtre et map", exo3, "exo3", [
    {args: ["a", "coucou ça va", "bob", "oui oui"], expectedResult: [
      {s: "A", t: 1},
      {s: "BOB", t: 3},
      {s: "OUI OUI", t: 7}
